...
best_model_path = os.path.join(SAVE_DIR, "antioxidative.pt")
...
results_df.to_csv(os.path.join(pred_path, "antioxidative_test_predictions.csv"), index=False)
df_folds.to_csv(os.path.join(pred_path, "antioxidative_10fold_results.csv"), index=False)
